...
4. Creamos dos modelos de regresión lineal simple con la variable dependiente "Estado de ánimo actual" 
4.1 Modelo 1 y 2 
...
En la tabla para el modelo 1 los valores p no son estadísticamente significativos para ninguna de las categorías. Esto quiere decir que, las respuestas asociadas al tipo de vivienda: departamento por si sola, no afecta la percepción de empeoramiento del estado de ánimo durante la pandemia. Además el R^2 es demasiado bajo para indicar que el modelo entre estas dos variables es bueno. 
